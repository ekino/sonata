...
class SortAction
{
     ...
     * @return array
     */
    public function sortEntities(string $className, array $idsByPositions): array
    {
     ...
     * @return array
     */
    public function generateUpdateQuery(string $className, array $idsByPositions): array
    {
        $queryStart = sprintf(
            'UPDATE %s SET %s = (case ',
     ...
     * @return bool
     */
    private function isSortableClass(string $className): bool
    {
